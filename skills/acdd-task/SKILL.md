...
7. **G0 Architecture**: Run `scripts/check_architecture_admission.py` before each launch. Complete `architecture/v1` through its coordinator procedure. On cap exhaustion, record `blocked` instead of thrashing.

...
""", encoding="utf-8")
    ...
    for gate, check in (("design/v1", "design-basis"), ("design/v1", "plan-shape"),
                        ("decompose/v1", "decomposition"), ("decompose/v1", "matrix")):
        flags = ("--classified-ref", "planning.md=plan") if check in {"design-basis", "decomposition", "matrix"} else ()
    ...
    transcript.write_text("\n".join(json.dumps(row) for row in (
        {"type": "review_raw", "reviewerSessionUuid": "00000000-0000-4000-8000-000000000002", "raw": "complete"},
        {"type": "review_terminal", "evidenceId": "review.independent", "gate": "review/v1",
         "check": "independent-review", "scope": ["planning.md"],
         "performedChecks": ["completeness", "consistency"], "verdict": "pass",
    ...
    run("review", "--gate", "review/v1", "--check", "independent-review",
        "--id", "review.independent", "--transcript", ".acdd/artifacts/review.jsonl",
